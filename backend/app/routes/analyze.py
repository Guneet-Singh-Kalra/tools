...
async def analyze_document(file: UploadFile = File(...)) -> AnalyzeResponse:
    ...
    return _analyze_text_pipeline(cleaned_text, filename)
...
async def analyze_text(payload: AnalyzeTextRequest) -> AnalyzeResponse:
    ...
    return _analyze_text_pipeline(cleaned_text, payload.document_name)


def _analyze_text_pipeline(text: str, document_name: str) -> AnalyzeResponse:
